 ...
 * @FileName	MysqlCreateTableManagerImpl.java
 * @package		com.model.util.mysql
 * @author		fuxianchao
 * @Date		2017年11月23日 下午4:18:01
 * @version		1.0
 ...
 * 系统启动时自动创建（修改）表
 ******************************************
 * @author fuxianchao  [2017年11月23日 下午4:18:01]
 * @version 1.0
 ******************************************
 */
public class MysqlCreateTableManagerImpl implements MysqlCreateTableManager {
	
	private static final Logger log = 
			LoggerFactory.getLogger(MysqlCreateTableManagerImpl.class);
	
	@Autowired
	private CreateMysqlTableMapper createMysqlTableMapper;
	...
	/* (non-Javadoc)
	 * @see com.model.util.mysql.MysqlCreateTableManager#createMysqlTable()
	 */
	@Override
	@PostConstruct
	public void createMysqlTable() {
		...
		// 构建出全部表的增删改的map
		allTableMapConstruct(mySqlTypeAndLengthMap, classes, newTableMap,
				modifyTableMap, addTableMap, removeTableMap,
	 ...
	 * 
	 ******************************************
	 * @author fuxianchao [2017年11月24日 上午9:30:46]
	 * @version 1.0
	 ******************************************
	 * 构建出全部表的增删改的map
	 * 
	...
	private void allTableMapConstruct(Map<String, Object> mySqlTypeAndLengthMap, Set<Class<?>> classes,
		...
		for (Class<?> clas : classes) {
			...
			if ("create".equals(tableAuto)) {
				createMysqlTableMapper.dorpTableByName(table.name());
			}

			// 先查该表是否以存在
			int exist = createMysqlTableMapper.findTableCountByTableName(table.name());
			...
			if (exist == 0) {
				...
				List<SysMysqlColumns> tableColumnList = createMysqlTableMapper
	 ...
	 * 递归扫描父类的fields
	 ******************************************
	 * @author fuxianchao [2017年11月27日 上午10:04:08]
	 * @version 1.0
	 ******************************************
	 * @param clas
	 * @param fields
	 ...
	 * 构建增加的删除的修改的字段
	 ******************************************
	 * @author fuxianchao [2017年11月27日 下午1:28:50]
	 * @version 1.0
	 ******************************************
	 * @param mySqlTypeAndLengthMap
	 *            获取Mysql的类型，以及类型需要设置几个长度
	 ...
	 * 根据数据库中表的结构和model中表的结构对比找出新增的字段
	 ******************************************
	 * @author fuxianchao [2017年11月27日 下午1:29:43]
	 * @version 1.0
	 ******************************************
	 * @param addTableMap
	 *            用于存需要增加字段的表名+结构
	 ...
	 ******************************************
	 * @author fuxianchao [2017年11月27日 下午1:30:46]
	 * @version 1.0
	 ******************************************
	 * @param removeTableMap
	 *            用于存需要删除字段的表名+结构
	 ...
	 ******************************************
	 * @author fuxianchao [2017年11月27日 下午1:31:34]
	 * @version 1.0
	 ******************************************
	 * @param mySqlTypeAndLengthMap
	 *            获取Mysql的类型，以及类型需要设置几个长度
